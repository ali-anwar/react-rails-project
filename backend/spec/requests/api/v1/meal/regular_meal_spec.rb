...
RSpec.describe 'Meal', type: :request do
  ...
  subject! { create(:meal, user: regular_user) }
  ...
  describe 'GET /meals' do
    context "regular_user user can't view other users meals" do
      before(:each) do
    ...
    context 'can view his meals' do
      ...
      it 'returns meals as json' do
        ...
        expect(meal['user_id']).to eq(regular_user.id)
      end
    end
  end

  describe 'POST /meals regular_user user' do
  ...
  describe 'PATCH /meals/:meal_id' do
    ...
    context 'regular_user can update his meals only' do
      before(:each) do
    ...
    context 'regular_user is not permitted to update other users meals' do
      before(:each) do
      ...
      it 'returns error' do
        ...
        expect(json['errors']['message']).to include 'You are not authorized to perform this action'
      end
    end
  ...
  describe 'DELETE /meals/:meal_id' do
    ...
    context 'regular user is not permitted to delete other user meals' do
      before(:each) do
